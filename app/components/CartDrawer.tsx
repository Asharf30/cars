...
const CartDrawer = () => {
  const { cartItems, isCartOpen, closeCart, updateQuantity, removeFromCart, clearCart, isMounted } = useCart();
                        ...
                        {cartItems.map((item) => (
                          ...
                          >
                            {/*
                              ...
                              [image 80px] [car info, grows] [subtotal+delete 90px]
                              This keeps the subtotal column fixed-width and flush-right
                              while the middle column grows/shrinks freely.
                            */}
                            <div className="grid grid-cols-[80px_1fr_90px] gap-3 p-4">
                              ...
                              <div className="flex flex-col justify-between min-w-0 py-0.5">
                                <div className="min-w-0">
                                  ...
                                  <p className="text-xs text-[#a69cac] mt-0.5">{item.year}</p>
                                </div>
                                ...
                                <div className="inline-flex items-center mt-3 bg-[#0f0518] rounded-lg border border-[rgba(0,229,255,0.15)] self-start">
                                  <button
                                    ...
                                    className="w-8 h-8 flex items-center justify-center text-[var(--color-neon-cyan)] hover:bg-[rgba(0,229,255,0.1)] disabled:opacity-30 disabled:hover:bg-transparent rounded-l-lg transition-colors text-base font-medium"
                                  >
                                    −
                                  </button>
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => updateQuantity(item.id, item.quantity + 1)}
                                    className="w-8 h-8 flex items-center justify-center text-[var(--color-neon-cyan)] hover:bg-[rgba(0,229,255,0.1)] rounded-r-lg transition-colors text-base font-medium"
                                  >
                                    +
                                  </button>
                                </div>
                              ...
                              {/* Column 3 — Subtotal + Delete, fixed 90px width */}
                              <div className="flex flex-col items-end justify-between py-0.5">
                                ...
                                <motion.button
                                  ...
                                  className="flex items-center justify-center w-7 h-7 rounded-md text-[#a69cac] hover:text-[var(--color-neon-violet)] hover:bg-[rgba(181,23,158,0.1)] transition-colors"
                                ...
                                <div className="flex flex-col items-end">
                                  <p className="text-[10px] text-[#a69cac] uppercase tracking-widest leading-none mb-1">
                                    Subtotal
                                  </p>
                                  <p className="text-sm font-bold text-[var(--color-neon-cyan)] leading-none">
                ...
                {cartItems.length > 0 && (
                  <div className="shrink-0 px-6 py-5 border-t border-[rgba(0,229,255,0.12)] bg-[rgba(15,5,24,0.6)]">
                    ...
                    <div className="flex items-center justify-between mb-5">
                      <span className="text-[#a69cac] font-medium text-base">Total Price</span>
                    ...
                    <div className="flex gap-3">
                      <button
                        type="button"
                        onClick={clearCart}
                        className="flex-1 h-11 flex items-center justify-center rounded-xl border border-[rgba(181,23,158,0.5)] text-[#a69cac] text-sm font-semibold hover:bg-[rgba(181,23,158,0.1)] hover:text-white transition-colors"
                      >
                        Clear Cart
                      </button>
                      <CustomButton
                        title="Checkout"
                        continerStyles="flex-[2] h-11 rounded-xl border border-[#C45AFF] bg-[var(--color-neon-violet)] text-white text-sm font-bold shadow-[0_10px_24px_rgba(176,38,255,0.24)] hover:bg-[#C34AFF] hover:shadow-[0_14px_30px_rgba(176,38,255,0.36)]"
